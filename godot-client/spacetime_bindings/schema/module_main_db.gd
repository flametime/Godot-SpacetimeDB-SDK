...
func _init(p_local_db: LocalDatabase) -> void:
	...
	test_event_table = preload('res://spacetime_bindings/schema/tables/main_test_event_table_table.gd').new(p_local_db)
